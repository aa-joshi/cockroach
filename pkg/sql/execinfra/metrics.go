...
type DistSQLMetrics struct {
	...
	ContendedQueriesCount       *aggmetric.AggCounter
	CumulativeContentionNanos   *aggmetric.AggCounter
...
func MakeDistSQLMetrics(histogramWindow time.Duration) DistSQLMetrics {
	return DistSQLMetrics{
		...
		ContendedQueriesCount:     aggmetric.NewCounterWithCacheStorageType(metaContendedQueriesCount),
		CumulativeContentionNanos: aggmetric.NewCounterWithCacheStorageType(metaCumulativeContentionNanos),
